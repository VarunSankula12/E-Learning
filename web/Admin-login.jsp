		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto col-6">
					...
					<li class="nav-item active"><a href="Admin-login.jsp" class="nav-link">Admin</a></li>
						...
						<div class="row no-gutters">
							<div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
								<div class="contact-wrap w-100 p-md-5 p-4">
									<h3 class="mb-4">Admin Login Page</h3>
                                                                        <form method="POST" id="myform" onsubmit="return validateuser()" action="Admin_LoginAction.jsp" name="myform" class="contactForm">
										<div class="row">
											<div class="col-md-12">
