...
<head>
	...
	<link rel="stylesheet" href="css/style.css">
        ...
        var specialization=document.myform.specialization.value;
        ...
        var resume=document.myform.resume.value;
        ...
        if (specialization===""){
            Swal.fire("specialization cannot be blank");            
            return false;
        }
        if (experience===""){
           Swal.fire("Experience cannot be blank");            
            return false;
        }
...
<body>
    ...
    <script>
        var successMessage = '${sessionScope.exists}';
        if (successMessage !== '') {
            Swal.fire({
                icon: 'warning',
                title: 'Exists!',
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto col-6">
					...
					<li class="nav-item active"><a href="Instructor-login.jsp" class="nav-link">Instructor</a></li>
	...
	<!-- END nav -->
		...
		<div class="hero-wrap hero-wrap-1.5"style="background-image: url('images/bg_2.jpg');">
		<div class="container">
			   ...
			   <div class="row justify-content-center pb-4">
				   <div class="col-md-12 heading-section text-center ftco-animate">
					   ...
					   <div class=" text-white">
						<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span><span class="mr-2"><a href="index.html">Instructor<i class="fa fa-chevron-right"></i></a></span><span class="mr-2"><a href="index.html">Instructor-registration<i class=""></i></a></span></p>
					</div>
						...
						<div class="row no-gutters">
							<div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
								<div class="contact-wrap w-100 p-md-5 p-4">
									<h3 class="mb-4">Instructor Registration Page</h3>
                                                                        <form method="POST" id="myform"onsubmit="return validateuser()" action="Instructor_RegAction.jsp" name="myform" class="contactForm" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="expirence">specialization</label>
													<input type="text" class="form-control" name="specialization" id="specialization" placeholder="java dev">
												</div>
											</div>

											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="email">Experience</label>
													<input type="text" class="form-control" name="experience" id="experience" placeholder="no of years" >
												</div>
											</div>
                                            ...
                                            <div class="col-md-12">
												...
												<div class="form-group">
													...
													<input type="file" class="form-control" name="file" id="file">
                                                                                    ...
                                                                                    <div class="col-md-12">
												<div class="form-group">
                                                    <label class="label" for="password">Upload Resume</label>
											...
											<div class="col-md-12">
												<div class="form-group">
                                                    ...
                                                    <label>To redirect to login page --> click <a href="Instructor-login.jsp">|here|</a></label>
												</div>
											</div>
										</div>
									</form>
