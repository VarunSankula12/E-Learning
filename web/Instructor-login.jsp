...
<body>
    ...
    <script>
        var successMessage = '${sessionScope.wrong}';
        if (successMessage !== '') {
            Swal.fire({
                icon: 'error',
                title: 'Failed!',
    ...
    <script>
        var successMessage = '${sessionScope.notAccepted}';
        if (successMessage !== '') {
            Swal.fire({
                icon: 'error',
                title: 'Failed!',
            ...
            <% session.removeAttribute("notAccepted"); %>
        }
          
    </script>
    <script>
        var successMessage = '${sessionScope.notRegistered}';
        if (successMessage !== '') {
            Swal.fire({
                icon: 'error',
                title: 'Failed!',
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto col-6">
					...
					<li class="nav-item active"><a href="Instructor-login.html" class="nav-link">Instructor</a></li>
	...
	<section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
		...
		<div class="text-white">
			<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span><span class="mr-2"><a href="index.html">Instructor login <i></i></a></span></p>
		</div>
		<div class="row justify-content-center pb-4">
			<div class="col-md-12 heading-section text-center ftco-animate">
				<span class="subheading"></span>
						...
						<div class="row no-gutters">
							<div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
								<div class="contact-wrap w-100 p-md-5 p-4">
									<h3 class="mb-4">Instructor Login Page</h3>
                                                                        <form method="POST" id="myform"  onsubmit="return validateuser()"  action="Instructor_LoginAction.jsp" name="myform" class="contactForm">
										<div class="row">
											<div class="col-md-12">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<label>Not yet registered ? <a href="Instructor-registration.jsp">SignUp</a></label>
												</div>
											</div>
										</div>
									</form>
							...
							<div class="col-lg-4 col-md-5 d-flex align-items-stretch">
								<div class="info-wrap bg-primary w-100 p-md-5 p-4">
									...
									<p class="mb-4">Please Login and Select your intrested courses.</p>
