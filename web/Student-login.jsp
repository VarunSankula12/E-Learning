<%-- 
    ...
    Created on : 4 Aug 2023, 16:06:02
    Author     : Aakhi
--%>
	...
	<section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
		...
		<div class="text-white">
			<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span>
				<span class="mr-2"><a href="index.html">Student <i></i></a></span></p>
		</div>
		<div class="row justify-content-center pb-4">
			<div class="col-md-12 heading-section text-center ftco-animate">
				<span class="subheading"></span>
						...
						<div class="row no-gutters">
							<div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
								<div class="contact-wrap w-100 p-md-5 p-4">
									<h3 class="mb-4">Student Login Page</h3>
                                                                        <form method="POST" id="myform" onsubmit="return validateuser()" action="Student_LoginAction.jsp" name="myform" class="contactForm">
										<div class="row">
											<div class="col-md-12">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<label>Not yet registered ? <a href="Student-registration.jsp">SignUp</a></label>
												</div>
											</div>
										</div>
									</form>
