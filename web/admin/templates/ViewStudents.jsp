  ...
  <div id="app">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              ...
              <ul class="menu-dropdown">
                ...
                <li><a href="Manage-Courses.jsp"><i class="ion ion-ios-circle-outline"></i> Manage Instructors</a></li>
              </ul>
            </li>
            <li>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <%
            int count = 1;
            ResultSet rs = adminDao.ViewStudents(new bean());
            while (rs.next()) {
                bean b = new bean();
                b.setEmail(rs.getString("student_email"));
                ResultSet stu = studentDao.subscriber(b);
                String courseNames = ""; 
                while (stu.next()) {
                    if (!courseNames.isEmpty()) {
                        courseNames =courseNames + ", ";
                    }
                    courseNames =courseNames + stu.getString("coursename");
                }
            %>
            <tr>
                <td><%= count %></td>
                ...
                <td><%= courseNames %></td> <!-- Display concatenated course names -->
