    ...
    <div class="row justify-content-end">
      ...
      <div class="col-lg-6">
        <div class="card bg-primary ">
          <div class="card-body">
            <h2 class="card-title text-center ">Instructor Edit Form</h2>
            <form method="POST" id="myform"onsubmit="return validateuser()" action="InstructorEditProfileAction.jsp" name="myform" class="contactForm" enctype="multipart/form-data">
              ...
              <div class="form-group text-dark">
                ...
                <input type="text" class="form-control" id="email" name="email" value="<%= rs.getString("email")%>" >
              </div>
               
              <div class="form-group text-dark">
                <label for="specialization">Specialization</label>
                <input type="text" class="form-control" id="specialization" name="specialization" value="<%= rs.getString("specialization")%>">
              </div>
                <div class="form-group text-dark">
                <label for="experience">Experience</label>
                <input type="text" class="form-control" id="experience" name="experience" value="<%= rs.getString("experience")%>">
              </div>
              <div class="form-group text-dark">
		...
		<input type="submit" class="btn btn-success" value="Update" class="btn btn-primary">
                ...
                <label class="text-white">Not Instrested?  <a class="text-white" href="Instructor-Dashboard.jsp"><b class="text-dark">Click here</b></a></label>
