...
<body>
    ...
    <script>
        var successMessage = '${sessionScope.notAuthorized}';
        if (successMessage !== '') {
            Swal.fire({
                icon: 'error',
            ...
            <% session.removeAttribute("notAuthorized"); %>
        }
    ...
    <script type="text/javascript">  
        ...
        var insname=document.myform.insname.value;
	...
	<section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
		...
		<div class="text-white">
            <p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home <i class="fa fa-chevron-right"></i></a></span>
                ...
                <span class="mr-2"><a href="Instructor-AddCourse.jsp">Add Course<i></i></a></span></p>	
        </div>
  ...
  <div class="container">
    <div class="row justify-content-end">
        <div class="col-6 col d-flex align-items-center">
            ...
            <img src="images/side-2.jpg" alt="Product Image" class="product-image">
        </div>
      <div class="col-lg-6">
        <div class="card bg-primary ">
          <div class="card-body">
            <h3 class="card-title text-center ">Add Course</h3>
            <form method="POST" id="myform"onsubmit="return validateuser()" action="AddCourseAction.jsp" name="myform"  enctype="multipart/form-data">
                <div class="form-group text-dark">
                <label for="coursename">Instructor Name</label>
                <input type="text" class="form-control" id="insname" name="insname" placeholder="Enter instructor name">
              </div>
              <div class="form-group text-dark">
              ...
              <div class="form-group text-dark">
                ...
                <input type="text" class="form-control" id="coursefee" name="coursefee" placeholder="10000rs">
              </div>
                <div class="form-group text-dark">
              ...
              <button type="submit" class="btn btn-dark btn-block">Add Course</button>
            </form>
          </div>
        </div>
      </div>
