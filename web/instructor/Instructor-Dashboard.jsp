...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto col-8">
					<li class="nav-item active"><a href="Instructor-Dashboard.jsp" class="nav-link">HOME</a></li>
	...
	<section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
		...
		<div class="text-white">
			<p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home <i class="fa fa-chevron-right"></i></a></span><span class="mr-2"><a href="index.html">Instructor
				 <i class="fa fa-chevron-right"></i></a></span><span class="mr-2"><a href="Instructor-Dashboard.jsp">Instructor Dashboard <i></i></a></span></p>
		</div>
		<div class="row justify-content-center pb-4">
			<div class="col-md-12 heading-section text-center ftco-animate bg-primary">
				<span class="subheading"></span>
			  <h2 class="mb-4">Instructor Dashboard
                              <img src="images/instructor-removebg-preview-removebg-preview.jpg" height="80px",width="40px"></h2>
		  </div></div>
        ...
        <%
            ...
            if(rs.next()){
                ...
                ResultSet result=studentDao.ViewStudents(b);
                while(result.next()){
                students++;
            }
            }
  ...
  <div class="container mt-5">
    <div class="row">
        <img src="images/student-1.jpg" height="80px",width="40px">
      <!-- Card 1 -->
      ...
      <%
          bean show=new bean();
          show.setEmail(email);
          ResultSet result=instructorDao.InstructorCourses(show);
          while(result.next()){
            courses++;
          }
      %>
      <div class="col-5 mb-4">
        <div class="card">
          <div class="card-header bg-success">View Courses</div>
          <div class="card-body">
            <p><%= courses%></p>
          </div>
        </div>
      </div>
          <img src="images/book-removebg-preview (1).jpg" height="80px",width="40px">
    </div>
          

          <%
          ResultSet set=studentDao.DisplayFeedback(b);
          while(set.next()){
            feedback++;
          }
      %>
    <div class="row">
      <!-- Card 3 -->
      <img src="images/feedback-removebg-preview.jpg" height="80px",width="40px">
      <div class="col-5 mb-4">
        <div class="card">
          <div class="card-header bg-danger">View Feedback</div>
          <div class="card-body">
            <p><%= feedback%></p>
          </div>
        </div>
      ...
      <div class="col-5 mb-4">
        <div class="card">
          <div class="card-header bg-warning">View Certifications </div>
          <div class="card-body">
            <p>3</p>
          </div>
        </div>
      </div>
      <img src="images/certificate-removebg-preview.jpg" height="80px",width="40px">
    </div>
  </div>
