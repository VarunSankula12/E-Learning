              ...
              <div class="col-lg-8 ">
                <div class="card  shadow-lg">
                  <div class="card-body text-center bg-primary">
                    ...
                    <h1 class="card-title"><%= rs.getString("student_name")%></h1>
                    <p class="card-text text-dark">Student</p>
                    
                  </div>
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item font-weightbold text-dark">
                        <strong>Email:</strong>&nbsp &nbsp<%= rs.getString("student_email")%>
                    </li>
                    <li class="list-group-item text-dark">
                      <strong>Mobile Num:</strong>&nbsp &nbsp<%= rs.getString("student_mobile")%>
                    </li>
                    <li class="list-group-item text-dark">
                      <strong>DOB:</strong>&nbsp &nbsp<%= rs.getString("student_dob")%>
                    </li>
                    <li class="list-group-item text-dark">
                        <strong>Gender:</strong>&nbsp &nbsp<%= rs.getString("student_gender")%>
                      </li>
                  </ul>
                </div><br>  
                      <a class="btn btn-primary d-flex justify-content-center" href="StudentProfileEdit.jsp">Edit</a>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <!-- Add your profile picture upload form here -->
