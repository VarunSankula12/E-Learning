...
<body>
	...
	<div class="container mt-5">
		<div class="row justify-content-end">
		  <div class="col-lg-6">
                      <form action="SearchCourse.jsp">
			<div class="input-group search-bar">
			  <input type="text" class="form-control search-input" id="search" name="search" placeholder="Search...">
	...
	<%
            String Profilepic="";
                ...
                search.setCoursename(request.getParameter("search"));
                ResultSet result=studentDao.SearchCourses(search);
                if(result.next()){
                    Blob pic=result.getBlob("upload_image");
...
%>
        ...
        <div class="col-md-4 d-flex align-items-stretch ftco-animate">
            <div class="project-wrap">
               <a href="courseAction.jsp?coursename=<%= java.net.URLEncoder.encode(result.getString("coursename"), "UTF-8") %>" class="img" style="background-image: url('data:image/jpeg;base64,<%= Profilepic %>');">
               <span class="price">Software</span>
               </a>
                <div class="text p-4">
                    <h3><a href="#"><%= result.getString("coursename") %></a></h3>
                    <p class="advisor">Advisor <span><%= result.getString("instructor_name") %></span></p>
                    <ul class="d-flex justify-content-between">
                        <li><span class="flaticon-shower"></span>CourseFee</li>
                        <li class="price"><%= result.getString("coursefee") %></li>
                    </ul>
                </div>
            </div>
        </div>
...
%>
        ...
        <div class="col-md-4 d-flex align-items-stretch ftco-animate">
            <div class="project-wrap">
               <a href="courseAction.jsp?coursename=<%= java.net.URLEncoder.encode(rs.getString("coursename"), "UTF-8") %>" class="img" style="background-image: url('data:image/jpeg;base64,<%= Profilepic %>');">
               <span class="price">Software</span>
               </a>
                <div class="text p-4">
                    <h3><a href="#"><%= rs.getString("coursename") %></a></h3>
                    <p class="advisor">Advisor <span><%= rs.getString("instructor_name") %></span></p>
                    <ul class="d-flex justify-content-between">
                        <li><span class="flaticon-shower"></span>CourseFee</li>
                        <li class="price"><%= rs.getString("coursefee") %></li>
                    </ul>
                </div>
            </div>
        </div>
