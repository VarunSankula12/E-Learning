...
<body>
    <script>
        var successMessage = '${sessionScope.FeedbackSubmissionSuccess}';
        if (successMessage !== '') {
            Swal.fire({
                icon: 'success',
                title: 'Success!',
            ...
            <% session.removeAttribute("FeedbackSubmissionSuccess"); %>
        }
          
    </script>
        <script>
        var successMessage = '${sessionScope.FeedbackSubmissionFailed}';
        if (successMessage !== '') {
            Swal.fire({
                icon: 'error',
                title: 'Failed!',
            ...
            <% session.removeAttribute("FeedbackSubmissionFailed"); %>
        }
		  ...
		  <div class="col-lg-6">
			<div class="input-group search-bar">
			  ...
			  <div class="input-group-append">
				<button class="btn search-button btn-primary" type="button">Search</button>
			  </div>
			</div>
		  </div>
		</div>
...
%>
        ...
        <div class="col-md-4 d-flex align-items-stretch ftco-animate">
            <div class="project-wrap">
               <a href="<%= result.getString("url") %>" class="img" style="background-image: url('data:image/jpeg;base64,<%= Profilepic %>');">
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <ul class="d-flex justify-content-start">
                ...
                <li class="price"><a href="<%= result.getString("url") %>">Watch Video</a></li>
            </ul>
        </div>
        <div>
            <a class="btn btn-danger" href="Student-Feedback.jsp?instructor_name=<%= rs.getString("instructor_name")%>&coursename=<%= rs.getString("coursename")%>">Feedback</a>
