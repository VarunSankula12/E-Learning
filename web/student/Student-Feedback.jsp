	...
	<section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
		...
		<div class="text-white">
            <p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home <i class="fa fa-chevron-right"></i></a></span>
                ...
                <span class="mr-2"><a href="course.jsp">Courses <i class="fa fa-chevron-right"></i></a></span>
                <span class="mr-2"><a href="Student-Feedback.jsp">Feedback <i></i></a></span></p>
			</div>
		<div class="row justify-content-center pb-4">
		  ...
		  <div class="container">
			<div class="row justify-content-end">
				<div class="col-6 col d-flex align-items-center">
					...
					<img src="images/feedback.jpg" alt="Product Image" class="product-image">
				</div>
			  ...
			  <div class="col-lg-6">
				<div class="card bg-primary">
				  <div class="card-body">
					<h3 class="card-title text-center text-white">Student Feedback</h3>
                                        <form method="POST" id="myform" onsubmit="return validateuser()" action="Student-FeedbackAction.jsp" name="myform" class="contactForm">
						
						<div class="form-group text-white">
							<label for="instructorName">Instructor Name:</label>
							<input type="text" class="form-control" id="studentName" name="instructor_name" value="<%= instructor_name%>" readonly>
						  </div>
						<div class="form-group text-white">
						  <label for="Coursename">Coursename:</label>
						  <input type="text" class="form-control" id="subject" name="coursename" value="<%= coursename%>" readonly>
						</div>
						<div class="form-group text-white">
						...
						<div class="container">
						  ...
						  <div class="rating"  id="rating" required>
						  ...
						  <p class="text-white">Selected rating: <span id="selectedRating">0</span></p>
