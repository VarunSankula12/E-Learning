	...
	<section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
		...
		<div class="text-white">
			<p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home <i class="fa fa-chevron-right"></i></a></span>
                ...
                <span class="mr-2"><a href="Student-Quiz.jsp">Quiz <i></i></a></span></p>
		</div>
		<div class="row justify-content-center pb-4">
			<div class="col-md-12 heading-section text-center ftco-animate bg-primary">
				<span class="subheading"></span>
			  <h2 class="mb-4">Student-Quiz</h2>
		  </div></div>
...
<%
            ...
            b.setName(instructor_name);
            ResultSet result=instructorDao.DisplayQuiz(b);
            if(result.next()){
                  ...
                  <tr>
                    <td>
                      ...
                      <div class="table-links">
                        <a href="course.html"><label class="text-Primary"><%= result.getString("coursename")%></label></a>
                        
                      </div>
                    </td>
                    <td>
                        <a class="btn btn-success" href="Student-Access-Quiz.jsp?coursename=<%= result.getString("coursename")%>" >Take Test</a>
                    </td>
                  </tr>
