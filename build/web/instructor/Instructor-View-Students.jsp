		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto col-8">
					...
					<li class="nav-item active"><a href="Instructor-View-Students.jsp" class="nav-link">VIEWSTUDENTS</a></li>
	...
	<section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
		...
		<div class="text-white">
			<p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home <i class="fa fa-chevron-right"></i></a></span>
                ...
                <span class="mr-2"><a href="Instructor-View-Students.jsp">View Students<i></i></a></span></p>
		</div>
		<div class="row justify-content-center pb-4">
...
<%
    ...
    if(rs.next()){
        ...
        ResultSet viewStu=studentDao.ViewStudents(b);
        while(viewStu.next()){
        b.setEmail(viewStu.getString("student_email"));
        ResultSet data=studentDao.Getter(b);
        while(data.next()){
%>
                  ...
                  <tr class="table-secondary">
                    ...
                    <td><%= data.getString("student_email") %></td>
                    <td><%= viewStu.getString("coursename") %></td>
                    <td><%= data.getString("student_gender") %></td>
                    <td><%= data.getString("student_mobile") %></td>
                  </tr>
<%
    count++;
        }
