...
<body>
    ...
    <script type="text/javascript">  
        ...
        var questionCount=document.myform.questionCount.value;
        
        if (questionCount===""){ 
            Swal.fire('Nmber of Questions are not Selected'); 
          return false;  
        }
        if(coursename==="select-coursename"){
            Swal.fire("Select a Coursename");
            return false;
        }
    }
        </script>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto col-8">
					...
					<li class="nav-item active"><a href="Instructor-AddTest.jsp" class="nav-link">ADDTEST</a></li>
	...
	<section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
		...
		<div class="text-white">
            <p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home <i class="fa fa-chevron-right"></i></a></span>
                ...
                <span class="mr-2"><a href="Instructor-AddTest.jsp">Add Test<i></i></a></span></p>	
        </div>
		<div class="row justify-content-center pb-4">
 ...
 <div class="container mt-5">
    <form method="POST" id="myform" onsubmit="return validateuser()" action="AddTestAction.jsp" name="myform">
            ...
            for (var i = 1; i <= questionCount; i++) {
                var questionHtml = `
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="question_${i}" required>
                    </div>
                    <div class="form-group">
                        <label for="option_${i}_1">Option 1:</label>
                        <input type="text" class="form-control" name="option_${i}_1" required>
                    </div>
                    <div class="form-group">
                        <label for="option_${i}_2">Option 2:</label>
                        <input type="text" class="form-control" name="option_${i}_2" required>
                    </div>
                    <div class="form-group">
                        <label for="option_${i}_3">Option 3:</label>
                        <input type="text" class="form-control" name="option_${i}_3" required>
                    </div>
                    <div class="form-group">
                        <label for="option_${i}_4">Option 4:</label>
                        <input type="text" class="form-control" name="option_${i}_4" required>
                    </div>
                    <div class="form-group">
                        <label for="correctAnswer_${i}">Correct Answer:</label>
                        <select class="form-control" name="correctAnswer_${i}" required>
