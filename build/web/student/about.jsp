...
<body>
 ...
 <section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
  ...
  <div class="text-white">
    <p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home <i class="fa fa-chevron-right"></i></a></span><span class="mr-2"><a href="about.jsp">About <i></i></a></span></p>
  </div>
  <div class="row justify-content-center pb-4">
    <div class="col-md-12 heading-section text-center ftco-animate">
      <span class="subheading"></span>
   ...
   <div class="col-md-6 pl-md-5 py-5">
    <div class="row justify-content-start pb-3">
      <div class="col-md-12 heading-section ftco-animate">
       ...
       <p>With E-learning, students can learn at their own pace, from anywhere and at any time. E-learning also makes the learning process more immersive and interactive, Students can connect with the instructors and get their doubts solved easily.</p>
       <p><a href="../contact.jsp" class="btn btn-primary">Get in touch with us</a></p>
     </div>
   </div>
 </div>
</div>
  ...
  <div class="row justify-content-center">
   <div class="col-md-12 text-center">
    <div class="img"  style="background-image: url(images/bg_4.jpg);">
     ...
     <p class="mb-0"><a href="../index.html" class="btn btn-primary px-4 py-3">Enroll Now</a></p>
   </div>
 </div>
</div>
</div>
    ...
    <div class="row d-flex">
      <div class="col-md-6 heading-section pr-md-5 ftco-animate d-flex align-items-center">
       <div class="w-100 mb-4 mb-md-0">
        ...
        <p>E-learning offers several advantages that make it a compelling and effective mode of education. It is Cost-Effective and Students can attend assessments to know thier status.</p>
        <p>With E-learning, students can learn at their own pace, from anywhere and at any time. E-learning also makes the learning process more immersive and interactive, Students can connect with the instructors and get their doubts solved easily.</p>
        <div class="d-flex video-image align-items-center mt-md-4">
          <a href="https://www.youtube.com/watch?v=1SZle1skb84" data-vbtype="video" class="video img d-flex align-items-center justify-content-center" style="background-image: url(images/about.jpg);">
      ...
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services">
          ...
          <div class="media-body">
            ...
            <p>Instructors are very experienced,so that students get a good quality content.</p>
          </div>
        </div>      
      </div>
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services">
          ...
          <div class="media-body">
            ...
            <p>We hire the instructors who are experienced and as well as skilled.</p>
          </div>
        </div>    
      </div>
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services">
          ...
          <div class="media-body">
            ...
            <p>StudyLab not only focusses on hiring expert instructor but also want our students who take our courses should be skilled after completing the course. </p>
          </div>
        </div>      
      </div>
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services">
          ...
          <div class="media-body">
            ...
            <p>Students can take the course and complete it to get certified.</p>
          </div>
        </div>      
      </div>
    </div>
