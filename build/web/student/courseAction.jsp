 ...
 <div class="container">
    <div class="row justify-content-end">
        <div class="col-6 col d-flex align-items-center justify-content-start">
            <img src='data:image/jpeg;base64,<%= Profilepic %>'height="300px",width="200px">
        </div>
      <div class="col-lg-6">
        <div class="card bg-primary ">
          <div class="card-body">
            ...
            <form>
                ...
                <input type="text" class="form-control" id="insname" name="insname" value="<%= rs.getString("instructor_name")%>" readonly>
              </div>
              <div class="form-group text-dark">
                <label for="coursename">Course Name</label>
                <input type="text" class="form-control" id="coursename" name="coursename" value="<%= rs.getString("coursename")%>" readonly>
              </div>
              <div class="form-group text-dark">
                <label for="category">Category</label>
                <input type="text" class="form-control" id="category" name="category" value="<%= rs.getString("category")%>" readonly>
              </div>
               
              <div class="form-group text-dark">
                <label for="coursefee">Course Fee</label>
                <input type="text" class="form-control" id="fee" name="coursefee" value="<%= rs.getString("coursefee")%>" readonly>
              </div>
                <div class="form-group text-dark">
                <label for="duration">Duration</label>
                <input type="text" class="form-control" id="duration" name="duration" value="<%= rs.getString("duration")%>"readonly>
              </div>
              <a  class="btn btn-dark" href="CoursePayment.jsp?coursename=<%=java.net.URLEncoder.encode(rs.getString("coursename"),"UTF-8")%>&instructor_name=<%=java.net.URLEncoder.encode(rs.getString("instructor_name"),"UTF-8")%>">Buy</a>
              <a class="text-white" href="course.jsp">Not Instrested? <b>Click here</b></a>
            </form>
          </div>
        </div>
      </div>
 ...
 <div class="container">
  <div class="row pb-4">
    <div class="col-md-7 heading-section ftco-animate">
     ...
     <h2 class="mb-4">What Students Says</h2>
   </div>
 </div>
</div>
  ...
  <div class="row ftco-animate">
    <div class="col-md-12">
      <div class="carousel-testimony owl-carousel">
          <%
      String name="";
              bean feedback=new bean();
              feedback.setCoursename(coursename);
              feedback.setName(rs.getString("instructor_name"));
              
              ResultSet result=studentDao.DisplayCourseFeedback(feedback);
              while(result.next()){
              feedback.setEmail(result.getString("student_email"));
              rating=Integer.parseInt(result.getString("rating"));
              ResultSet stuName=studentDao.Getter(feedback);
              if(stuName.next()){
              name=stuName.getString("student_name");
      }
          %>
        <div class="item">
          <div class="testimony-wrap py-4">
            ...
            <p class="mb-4"><%= result.getString("feedback")%></p>
