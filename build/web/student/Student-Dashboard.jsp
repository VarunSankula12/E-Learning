		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto col-4">
					<li class="nav-item active"><a href="Student-Dashboard.html" class="nav-link">Home</a></li>
	...
	<section class="hero-wrap hero-wrap-1" style="background-image: url('images/bg_2.jpg');">
		...
		<div class="text-white">
			<p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home <i class="fa fa-chevron-right"></i></a></span>
				<span class="mr-2"><a href="Student-login.jspl">Student <i class="fa fa-chevron-right"></i></a></span>
				<span class="mr-2"><a href="Student-Dashboard.jsp">Student Dashboard <i></i></a></span></p>
		</div>
		<div class="row justify-content-center pb-4">
			<div class="col-md-12 heading-section text-center ftco-animate bg-primary">
				<span class="subheading"></span>
			  <h2 class="mb-4">Student Dashboard 
                              <img src="images/student-removebg-preview.jpg" height="80px",width="40px"></h2>
		  </div></div>
        ...
        <%
            ...
            int feedback=0;
                ...
                bean b=new bean();
                b.setEmail(mail);
                ResultSet rs=studentDao.subscriber(b);
                while(rs.next()){
                courses++;
            }
            ResultSet result=studentDao.GivenFeedback(b);
            while(result.next()){
                feedback++;
            }
					  ...
					  <div class="card card-sm-3">
						...
						<div class="card-wrap">
						  <div class="card-header bg-danger">
							<h4 class="text-white">View Exams</h4>
						  </div>
						  <div class="card-body">
							<%= courses%>
						  </div>
                                                  ...
                                                  <img src="images/exam-removebg-preview (1).jpg" height="80px",width="40px">
					  ...
					  <div class="card card-sm-3">
						...
						<div class="card-wrap">
						  <div class="card-header bg-dark">
							<h4 class="text-white">Feedback given</h4>
						  </div>
						  <div class="card-body ">
							<%= feedback%>
						  </div>
